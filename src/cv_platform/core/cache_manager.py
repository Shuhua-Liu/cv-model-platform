"""
Cache Manager - Advanced caching system for models and data

Provides intelligent caching with LRU eviction, memory monitoring, 
persistence, and automatic cleanup mechanisms.
"""
...
class CacheManager:
    """Advanced cache manager with multiple strategies and persistence"""
    ...
    def __init__(self,
        ...
        logger.info(f"Cache manager initialized - Strategy: {strategy.value}, "
                   f"Max size: {max_size_bytes / (1024*1024):.1f}MB, "
